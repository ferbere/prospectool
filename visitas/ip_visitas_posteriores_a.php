...
if(isset($_POST['visita_s'])){
	$visita_s=$_POST['visita_s'];
}
...
$sql=$mysql->consulta("UPDATE prospecta_visita_seg SET resuelve='$resuelve',resultado='$resultado' WHERE id = '$visita_s' AND visita ='$rubro'");
if(!$sql){
