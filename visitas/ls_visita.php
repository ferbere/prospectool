...
$prev=$mysql->consulta("SELECT vendedor FROM prospecta_visita WHERE vendedor = ".$_SESSION['id']);
$prow=$mysql->fetch_array($prev);
if(($_SESSION['privilegioss_id']>4)&&($_SESSION['id']!=$prow[0])){
...
<!-- Formato visitas{-->
	<div>
<?php
	$exts=$_SERVER['PHP_SELF'].'?ruta=visitas.php&form=1&rubro='.$rubro.'&visita_s=';
?>
	<div id="visitas_seg">
		<ul>
<?php
